...
config_file = 'packages/ssd_mobilenet_v3_large.pbtxt'
frozen_model = 'packages/ssd_mobilenet_v3_large.pbtxt'
model = cv2.dnn_DetectionModels(frozen_model, config_file)
...
img = cv2.imread("assets/img/LR 33.jpg")
plt.imshow(img)
...
video = 'assets/video/156156 (1080p).mp4'
